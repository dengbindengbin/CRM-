       ...
       switch (a.formType)
        {
           ...
           case 2:
               ...
               break;
           case 3:
               e = '<p>名称：<input type="' + (1 == a.formType ? "password" : "text") + '" class="layui-layer-input" value="' + (a.value || "") + '" style="display: inline-block;"></p><br>' + '<p>颜色：<input  data-inline="true" type="hidden" class="layui-layer-input2 " value="' + (a.value2 || "") + '"></p>';
               break
           default:
               e = '<input type="' + (1 == a.formType ? "password" : "text") + '" class="layui-layer-input" value="' + (a.value || "") + '">';
               break
       ...
       if (a.formType == 3) {
        ...
        return layer.open($.extend({
            ...
            success: function (a) {
                ...
                if (typeindex == 3) {
                    f = a.find(".layui-layer-input2").minicolors();
                }
        ...
        return layer.open($.extend({
            ...
            success: function (b) {
                ...
                c.on("mousedown", function (b) {
                    ...
                    c.addClass("layui-layer-tabnow").siblings().removeClass("layui-layer-tabnow"), d.eq(e).show().siblings().hide(),
            ...
            f.imgprev = function (a) {
                ...
                layer.close(f.loadi), f.index = layer.open($.extend({
                    ...
                    success: function (b, c) {
                        f.bigimg = b.find(".layui-layer-phimg"), f.imgsee = b.find(".layui-layer-imguide,.layui-layer-imgbar"),
                        f.event(b), a.tab && a.tab(i[j], b);
                    },
                    end: function () {
