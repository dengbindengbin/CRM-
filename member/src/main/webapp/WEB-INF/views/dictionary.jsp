...
<div id="cc" class="easyui-layout" style="width:600px;height:400px;" fit="true">
    ...
    <table id="dictionaryItem_datagrid">
        ...
        <tr>
            ...
            <th data-options="field:'datdict',align:'center',width:10 ,formatter:dictoryName">字典目录</th>
        </tr>
        </thead>
    </table>
        ...
        <form id="dictionaryitem_form" method="post">
            <table align="center" style="margin-top: 15px;">
                ...
                <tr>
                    <td>字典父目录</td>
                    <td>
                        <input class="easyui-combobox" id="comboboxDictionary"  name="datdict.id"
                               data-options="valueField:'id',textField:'name',url:'/dictionary_listAll',panelHeight:'auto',multiple:true"
                              />
                    </td>
                </tr>
            </table>
