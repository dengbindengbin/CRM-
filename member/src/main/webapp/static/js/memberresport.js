$(function(){
    ...
    //----------------------------------------------
    $.get("/memberResport_list",function (data2) {
    	console.log(data2)
    	var s= data2[0];
    	console.debug(s);
    	var bbb=0;
    	...
    	$("#recelivableName2").html((huia/bbb).toFixed(2))
    })
...
function TodaySearch(timeSearch){
	...
	//-------------------------
	$.get("/memberResport_load?amount="+timeSearch,function (data) {
        console.log(data)
        var s= data[0];
        console.debug(s);
        var ppp=0;
    ...
    //----------------------------------------------
    $.get("/memberResport_list?amount="+timeSearch,function (data2) {
    	console.log(data2)
    	var s= data2[0];
    	console.debug(s);
    	var bbb=0;
