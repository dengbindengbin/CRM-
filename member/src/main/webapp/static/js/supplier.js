$(function(){
	...
	supplierDatagrid.datagrid({
		...
		columns:[[
			{field:'factory',title:'厂商',width:100,align:'center'},
			{field:'debt',title:'应付欠款',width:100,align:'center'},
			{field:'name',title:'联系人',width:100,align:'center'},
			{field:'phone',title:'联系电话',width:100,align:'center'},
			{field:'qq',title:'QQ号码',width:100,align:'center'},
			{field:'address',title:'地址',width:100,align:'center'},
			{field:'addDate',title:'添加时间',width:100,align:'center'},
			{field:'remark',title:'备注信息',width:100,align:'center'},
			{field:'admin',title:'操作人员',width:100,align:'center'}
		]]
	});
